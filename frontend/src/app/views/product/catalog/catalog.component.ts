...
export class CatalogComponent implements OnInit {
  ...
  sortingOptions: { name: string, value: string | null }[] = [
    ...
    {name: 'Сбросить сортировку', value: null},
  ];
          ...
          .subscribe(params => {
            ...
            if (this.activeParams.heightFrom) {
              this.appliedFilters.push({
                ...
                urlParam: CONSTANTS.heightFrom,
              });
            }
            if (this.activeParams.heightTo) {
              this.appliedFilters.push({
                name: `Высота: до ${this.activeParams.heightTo} см`,
                urlParam: CONSTANTS.heightTo,
              });
            }
            if (this.activeParams.diameterFrom) {
              this.appliedFilters.push({
                name: `Диаметр: от ${this.activeParams.diameterFrom} см`,
                urlParam: CONSTANTS.diameterFrom,
              });
            }
            if (this.activeParams.diameterTo) {
              this.appliedFilters.push({
                name: `Диаметр: до ${this.activeParams.diameterTo} см`,
                urlParam: CONSTANTS.diameterTo,
              });
            }
  ...
  removeAppliedFilter(appliedFilter: appliedFilterType): void {
    if (appliedFilter.urlParam === CONSTANTS.heightFrom || appliedFilter.urlParam === CONSTANTS.heightTo
      || appliedFilter.urlParam === CONSTANTS.diameterFrom || appliedFilter.urlParam === CONSTANTS.diameterTo) {
